...
Una via percorribile è rappresentata dal problema variazionale come fu formulato da Peebels in \parencite{peebles}.
...
\begin{center}
	\begin{figure}[H]
        ...
        l'accordo corretto si trova con l'orbita prevista con il punto di sella. Immagine tratta da \parencite{mohayaee}.}
		\label{fig:peebles}
	\end{figure}
\end{center}
...
di una funzione di $\bm{x}$. I dettagli della trattazione sono reperibili in \parencite{mohayaee} e \parencite{matarrese}.
Per risolvere l'equazione \ref{eqn:mongeampere} la si discretizza e si risolve il relativo problema di assegnazione 
tramite algoritmi numerici, come quelli presentati in \parencite{mohayaee}, che permettano di preservare l'unicità
delle soluzioni.
