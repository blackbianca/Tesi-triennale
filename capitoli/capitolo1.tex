...
e $\delta\rho$ costituisce una deviazione da tale valore medio. $\Phi = \Phi_b + \phi_0$ invece
è la somma di un potenziale di background e un potenziale peculiare $\phi_0$. Grazie a queste due 
...
\begin{equation}
    \label{eqn:poissonx}
    \laplacian_{\bm{x}}\phi_0 = 4\pi G \delta\rho
\end{equation}
...
\begin{gather}
    ...
    \phi_0 \mapsto \phi = \frac{3t_{*}^2}{2a_{*}^3}\phi_0
\end{gather}
Grazie alla mappatura $(\rho, \bm{v}, \phi_0)\mapsto(\eta, \bm{u}, \phi)$, le equazioni del fluido assumono
la nuova forma 
...
L'approssimazione di Zel'dovich sta nel considerare tale risultato anche oltre il regime di linearità, ossia 
