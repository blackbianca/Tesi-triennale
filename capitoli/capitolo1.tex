...
- introdurre le caustiche proseguendo sulla linea delle note di matarrese
- dire che il problema si può affrontare anche come problema di minimizzazione, partendo dall'ipotesi di
mappa lagrangiana potenziale ed arrivando all'equazione MAK (citare articolo Moyahee) 
